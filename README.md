...
A real-time backend monitoring system that tracks API uptime, latency, and incidents with a modern dashboard and live analytics.

---

## 📊 Infrastructure Dashboard

<img src="https://raw.githubusercontent.com/srimankeerthi/Smart_api_monitor/main/assets/dashboard-overview.png" width="100%" />

### 🧠 What this shows

* ✅ Real-time API health monitoring
* ⏱️ Latency tracking with dynamic graphs
* 📊 Service status overview (Operational / Down / Maintenance)
* 🔄 Auto-updating dashboard (live feel)
...
<img src="https://raw.githubusercontent.com/srimankeerthi/Smart_api_monitor/main/assets/incident-monitoring.png" width="100%" />

### ⚡ Features

* 🚨 Live incident feed with timestamps
* ⚠️ Error detection (timeouts, delays, failures)
* 📍 Region-based issue tracking
* 🕒 Real-time updates (seconds-level freshness)
...
* **Monitoring Logic:** Polling-based scheduler
